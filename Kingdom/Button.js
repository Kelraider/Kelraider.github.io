...
Button.prototype.display = function() {
  ...
  if (!this.isHidden) {
    ...
    noStroke();
    text(this.innerText, 
      this.pos.x+3, this.pos.y+(this.sizeH/2)-(this.txtSize/2), this.sizeW, this.sizeH);
  }
}
...
function PartyTab(x, y, w, h) {
  Tab.call(this, x, y, w, h);
}

PartyTab.prototype = Object.create(Tab.prototype);
PartyTab.prototype.constructor = Tab;
PartyTab.prototype.isPartyTab = true;
